...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/VGAFirstProject/VGAFirstProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaController_s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vgaController_s.tcl -notrace
