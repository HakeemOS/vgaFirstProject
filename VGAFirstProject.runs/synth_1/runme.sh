...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/VGAFirstProject/VGAFirstProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaController_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgaController_s.tcl
